...
//       <h3 className="title__sub">Filip & Henon Wedding</h3>
...
//                   <button title="emoticon" class="custom-emoji-botton">
//                     😊
//                   </button>
//                 </EmojiMartPicker>
//               </div>
...
//                   <li>Pesan ini akan tampil di halaman depan, tapi tidak realtime (ada jeda waktu)</li>
//                   <li>Ukuran foto tidak perlu presisi, karna akan menyesuaikan</li>
//                 </ul>
//                 <br />
//               </div>
//             </div>
